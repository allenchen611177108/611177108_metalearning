...
metalr_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer=meta_optimizer, T_max=350, eta_min=0.0001)
...
torch.save({
            ...
            }, 'C:/allen_env/deeplearning/result/model/FCN_Model_meta_1b.pth')
...
with open("C:/allen_env/deeplearning/code/MetaLearning/record/meta_1b.xml", "w") as file:
