...
randset = reductionset('C:/allen_env/deeplearning/7f/fold_7/train_set', transform=img_trans,
                   mask_transform=mask_trans)
randloader = torch.utils.data.DataLoader(randset, batch_size=1, shuffle=True, num_workers=0)

validset = reductionset('C:/allen_env/deeplearning/7f/fold_7/test_set', transform=img_trans,
                   mask_transform=mask_trans)
...
model_path = "C:/allen_env/deeplearning/result/checkpoint/7fold7_bp_best_673.pth"
test_net = FCN(2)
